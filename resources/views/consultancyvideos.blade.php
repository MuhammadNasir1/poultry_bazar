        ...
        <x-slot name="tablebody">
            ...
            <tr>
                ...
                <td class="min-w-[200px]">
                    <a href="{{ ltrim(str_replace(url('/'), '', $data->media_image), '/') }}" class=" hover:underline text-customOrangeDark" target="_blank">
                        Watch Video
                    </a>
            ...
            <form id="postDataForm" method="POST" url="../saveMedia" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 grid-cols-2 ">
                    <div>
                        <div class="">
                            ...
                            <div class="w-full">
                                <label for="mediaAuthor"
                                    ...
                                    Video</label>
                                <input type="text" name="media_image" id="videoLabel"
                                    placeholder="Add Consultancy Video"
                        ...
                        <!-- <input id="videoLabel" type="text" class="file-input " name="media_image" /> -->
    ...
    <x-modal id="view-modal">
        ...
        <x-slot name="body">
            <div class="p-6">
                ...
                <div class="mt-6">
                    <h4 class="text-lg font-semibold text-gray-800">Video Link:</h4>
                    <p class="mt-2 text-sm text-gray-600" id="dImage"></p>
                </div>
                <!-- Description -->
                <div class="mt-6">
...
<script>
    ...
    function viewData() {
        ...
        $('.viewModalBtn').click(function() {
            ...
            $('#dImage').text($(this).attr('mediaImage'));
    ...
    function updateDatafun() {
        ...
        $('.updateDataBtn').click(function() {
            ...
            $('#videoLabel').val(mediaDetails.attr('mediaImage'));
